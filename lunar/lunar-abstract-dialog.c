...
static void lunar_abstract_dialog_close      (GtkDialog                 *dialog);



G_DEFINE_ABSTRACT_TYPE (LunarAbstractDialog, lunar_abstract_dialog, GTK_TYPE_DIALOG)



static void
lunar_abstract_dialog_class_init (LunarAbstractDialogClass *klass)
{
  GtkDialogClass *gtkdialog_class;
  GtkBindingSet  *binding_set;

  gtkdialog_class = GTK_DIALOG_CLASS (klass);
  gtkdialog_class->close = lunar_abstract_dialog_close;
...
static void
lunar_abstract_dialog_init (LunarAbstractDialog *dialog)
{
}
...
static void
lunar_abstract_dialog_close (GtkDialog *dialog)
{
  GdkEvent *event;
