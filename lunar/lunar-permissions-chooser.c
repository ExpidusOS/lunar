...
enum
{
  LUNAR_PERMISSIONS_STORE_COLUMN_NAME,
  LUNAR_PERMISSIONS_STORE_COLUMN_GID,
  LUNAR_PERMISSIONS_STORE_N_COLUMNS,
};



static void                 lunar_permissions_chooser_finalize         (GObject                        *object);
static void                 lunar_permissions_chooser_get_property     (GObject                        *object,
                                                                         guint                           prop_id,
                                                                         GValue                         *value,
                                                                         GParamSpec                     *pspec);
static void                 lunar_permissions_chooser_set_property     (GObject                        *object,
                                                                         guint                           prop_id,
                                                                         const GValue                   *value,
                                                                         GParamSpec                     *pspec);
static gint                 lunar_permissions_chooser_ask_recursive    (LunarPermissionsChooser       *chooser);
static void                 lunar_permissions_chooser_change_group     (LunarPermissionsChooser       *chooser,
                                                                         guint32                         gid);
static gboolean             lunar_permissions_chooser_change_mode      (LunarPermissionsChooser       *chooser,
                                                                         LunarFileMode                  dir_mask,
                                                                         LunarFileMode                  dir_mode,
                                                                         LunarFileMode                  file_mask,
                                                                         LunarFileMode                  file_mode);
static void                 lunar_permissions_chooser_access_changed   (LunarPermissionsChooser       *chooser,
                                                                         GtkWidget                      *combo);
static void                 lunar_permissions_chooser_file_changed     (LunarPermissionsChooser       *chooser);
static void                 lunar_permissions_chooser_group_changed    (LunarPermissionsChooser       *chooser,
                                                                         GtkWidget                      *combo);
static void                 lunar_permissions_chooser_program_toggled  (LunarPermissionsChooser       *chooser,
                                                                         GtkWidget                      *button);
static void                 lunar_permissions_chooser_fixperm_clicked  (LunarPermissionsChooser       *chooser,
                                                                         GtkWidget                      *button);
static LunarJobResponse    lunar_permissions_chooser_job_ask          (LunarPermissionsChooser       *chooser,
                                                                         const gchar                    *message,
                                                                         LunarJobResponse               choices,
                                                                         LunarJob                      *job);
static void                 lunar_permissions_chooser_job_cancel       (LunarPermissionsChooser       *chooser);
static void                 lunar_permissions_chooser_job_error        (LunarPermissionsChooser       *chooser,
                                                                         GError                         *error,
                                                                         LunarJob                      *job);
static void                 lunar_permissions_chooser_job_finished     (LunarPermissionsChooser       *chooser,
                                                                         LunarJob                      *job);
static void                 lunar_permissions_chooser_job_percent      (LunarPermissionsChooser       *chooser,
                                                                         gdouble                         percent,
                                                                         LunarJob                      *job);
static void                 lunar_permissions_chooser_job_start        (LunarPermissionsChooser       *chooser,
                                                                         LunarJob                      *job,
                                                                         gboolean                        recursive);
static gboolean             lunar_permissions_chooser_row_separator    (GtkTreeModel                   *model,
                                                                         GtkTreeIter                    *iter,
                                                                         gpointer                        data);
static GList               *lunar_permissions_chooser_get_files        (LunarPermissionsChooser       *chooser);
static void                 lunar_permissions_chooser_set_files        (LunarPermissionsChooser       *chooser,
                                                                         GList                          *files);


struct _LunarPermissionsChooserClass
{
  GtkVBoxClass __parent__;
};

struct _LunarPermissionsChooser
{
  GtkVBox     __parent__;
...
G_DEFINE_TYPE (LunarPermissionsChooser, lunar_permissions_chooser, GTK_TYPE_BOX)



static void
lunar_permissions_chooser_class_init (LunarPermissionsChooserClass *klass)
{
  GObjectClass *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = lunar_permissions_chooser_finalize;
  gobject_class->get_property = lunar_permissions_chooser_get_property;
  gobject_class->set_property = lunar_permissions_chooser_set_property;

  /**
   * LunarPermissionsChooser:file:
   *
   * The #LunarFile whose permissions will be edited/viewed.
   **/
  ...
  /**
   * LunarPermissionsChooser:mutable:
   *
   * Whether the current #LunarFile<!---->s permissions are
   * mutable.
   **/
  g_object_class_install_property (gobject_class,
                                   PROP_MUTABLE,
...
static void
lunar_permissions_chooser_init (LunarPermissionsChooser *chooser)
{
  ...
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->user_label);
  ...
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[2]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[2]), "changed", G_CALLBACK (lunar_permissions_chooser_access_changed), chooser);
  ...
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[2]);
  ...
  gtk_cell_layout_add_attribute (GTK_CELL_LAYOUT (chooser->group_combo), renderer_text, "text", LUNAR_PERMISSIONS_STORE_COLUMN_NAME);
  gtk_combo_box_set_row_separator_func (GTK_COMBO_BOX (chooser->group_combo), lunar_permissions_chooser_row_separator, NULL, NULL);
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->group_combo), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->group_combo), "changed", G_CALLBACK (lunar_permissions_chooser_group_changed), chooser);
  gtk_widget_set_hexpand (chooser->group_combo, TRUE);
  gtk_grid_attach (GTK_GRID (chooser->grid), chooser->group_combo, 1, row, 1, 1);
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->group_combo);
  ...
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[1]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[1]), "changed", G_CALLBACK (lunar_permissions_chooser_access_changed), chooser);
  ...
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[1]);
  ...
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[0]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[0]), "changed", G_CALLBACK (lunar_permissions_chooser_access_changed), chooser);
  ...
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[0]);
  ...
  endo_binding_new (G_OBJECT (chooser->program_button), "visible", G_OBJECT (label), "visible");
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->program_button), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->program_button), "toggled", G_CALLBACK (lunar_permissions_chooser_program_toggled), chooser);
  gtk_grid_attach (GTK_GRID (chooser->grid), chooser->program_button, 1, row, 1, 1);
  lunar_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->program_button);
  gtk_widget_show (chooser->program_button);

  row += 1;

  hbox = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 6);
  endo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (hbox), "sensitive");
  endo_binding_new (G_OBJECT (chooser->program_button), "visible", G_OBJECT (hbox), "visible");
  gtk_grid_attach (GTK_GRID (chooser->grid), hbox, 1, row, 1, 1);
  gtk_widget_show (hbox);
  ...
  gtk_label_set_attributes (GTK_LABEL (label), lunar_pango_attr_list_small_italic ());
  ...
  gtk_label_set_attributes (GTK_LABEL (chooser->fixperm_label), lunar_pango_attr_list_small_italic ());
  gtk_label_set_line_wrap (GTK_LABEL (chooser->fixperm_label), TRUE);
  endo_binding_new (G_OBJECT (chooser->fixperm_label), "visible", G_OBJECT (hbox), "visible");
  ...
  g_signal_connect_swapped (G_OBJECT (chooser->fixperm_button), "clicked", G_CALLBACK (lunar_permissions_chooser_fixperm_clicked), chooser);
  endo_binding_new (G_OBJECT (chooser->fixperm_button), "visible", G_OBJECT (hbox), "visible");
  ...
  endo_binding_new (G_OBJECT (chooser->job_progress), "visible", G_OBJECT (hbox), "visible");
  ...
  g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (lunar_permissions_chooser_job_cancel), chooser);
...
static void
lunar_permissions_chooser_finalize (GObject *object)
{
  LunarPermissionsChooser *chooser = LUNAR_PERMISSIONS_CHOOSER (object);

  /* cancel any pending job */
  if (G_UNLIKELY (chooser->job != NULL))
    {
      /* cancel the job (if not already done) */
      endo_job_cancel (ENDO_JOB (chooser->job));
  ...
  lunar_permissions_chooser_set_files (chooser, NULL);

  (*G_OBJECT_CLASS (lunar_permissions_chooser_parent_class)->finalize) (object);
}



static void
lunar_permissions_chooser_get_property (GObject    *object,
                                         guint       prop_id,
                                         GValue     *value,
                                         GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FILES:
      g_value_set_boxed (value, lunar_permissions_chooser_get_files (chooser));
      break;

    case PROP_MUTABLE:
      for (lp = chooser->files; lp != NULL; lp = lp->next)
        if (!lunar_file_is_chmodable (LUNAR_FILE (lp->data)))
          break;
...
static void
lunar_permissions_chooser_set_property (GObject      *object,
                                         guint         prop_id,
                                         const GValue *value,
                                         GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FILES:
      lunar_permissions_chooser_set_files (chooser, g_value_get_boxed (value));
      break;
...
static gboolean
lunar_permissions_chooser_ask_recursive (LunarPermissionsChooser *chooser)
{
  LunarRecursivePermissionsMode mode;
  ...
  if (G_UNLIKELY (mode == LUNAR_RECURSIVE_PERMISSIONS_ASK))
    {
      ...
      switch (response)
        ...
        case GTK_RESPONSE_YES:
          if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (button)))
            g_object_set (G_OBJECT (preferences), "misc-recursive-permissions", LUNAR_RECURSIVE_PERMISSIONS_ALWAYS, NULL);
          break;

        case GTK_RESPONSE_NO:
          if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (button)))
            g_object_set (G_OBJECT (preferences), "misc-recursive-permissions", LUNAR_RECURSIVE_PERMISSIONS_NEVER, NULL);
          break;
  ...
  else if (mode == LUNAR_RECURSIVE_PERMISSIONS_ALWAYS)
    {
...
static gboolean
lunar_permissions_chooser_has_directory (LunarPermissionsChooser *chooser)
{
  GList *lp;

  for (lp = chooser->files; lp != NULL; lp = lp->next)
    if (lunar_file_is_directory (LUNAR_FILE (lp->data)))
      return TRUE;
...
static gboolean
lunar_permissions_chooser_is_fixable_directory (LunarFile *file)
{
  LunarFileMode mode;
...
static gboolean
lunar_permissions_chooser_has_fixable_directory (LunarPermissionsChooser *chooser)
{
  GList *lp;

  for (lp = chooser->files; lp != NULL; lp = lp->next)
    if (lunar_permissions_chooser_is_fixable_directory (LUNAR_FILE (lp->data)))
      return TRUE;
...
static GList *
lunar_permissions_chooser_get_file_list (LunarPermissionsChooser *chooser)
{
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      gfile = lunar_file_get_file (LUNAR_FILE (lp->data));
      _lunar_assert (G_IS_FILE (gfile));
...
static void
lunar_permissions_chooser_change_group (LunarPermissionsChooser *chooser,
                                         guint32                   gid)
{
  LunarJob *job;
  ...
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (chooser->files != NULL);

  /* check if we should operate recursively */
  if (lunar_permissions_chooser_has_directory (chooser))
    {
      response = lunar_permissions_chooser_ask_recursive (chooser);
      switch (response)
        {
        case GTK_RESPONSE_YES:
          recursive = TRUE;
        ...
        default:  /* cancelled by the user */
          lunar_permissions_chooser_file_changed (chooser);
          return;
        }
    }

  /* try to allocate the new job */
  file_list = lunar_permissions_chooser_get_file_list (chooser);
  job = lunar_io_jobs_change_group (file_list, gid, recursive);
  lunar_permissions_chooser_job_start (chooser, job, recursive);
...
static gboolean
lunar_permissions_chooser_change_mode (LunarPermissionsChooser *chooser,
                                        LunarFileMode            dir_mask,
                                        LunarFileMode            dir_mode,
                                        LunarFileMode            file_mask,
                                        LunarFileMode            file_mode)
{
  ...
  _lunar_return_val_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser), FALSE);
  _lunar_return_val_if_fail (chooser->files != NULL, FALSE);
  ...
  /* try to allocate the new job */
  file_list = lunar_permissions_chooser_get_file_list (chooser);
  job = lunar_io_jobs_change_mode (file_list, dir_mask, dir_mode, file_mask, file_mode, recursive);
  lunar_permissions_chooser_job_start (chooser, job, recursive);
  g_list_free_full (file_list, g_object_unref);
  g_object_unref (job);
...
static void
lunar_permissions_chooser_access_changed (LunarPermissionsChooser *chooser,
                                           GtkWidget                *combo)
{
  LunarFileMode  file_mask;
  LunarFileMode  file_mode;
  ...
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (GTK_IS_COMBO_BOX (combo));
  ...
  if (lunar_permissions_chooser_change_mode (chooser, dir_mask, dir_mode, file_mask, file_mode))
    {
               ...
               gpointer      group_primary)
{
  ...
  guint32 group_a_id = lunar_group_get_id (LUNAR_GROUP (group_a));
  guint32 group_b_id = lunar_group_get_id (LUNAR_GROUP (group_b));
  ...
  if (group_primary != NULL)
    {
      group_primary_id = lunar_group_get_id (LUNAR_GROUP (group_primary));
  ...
  return g_ascii_strcasecmp (lunar_group_get_name (LUNAR_GROUP (group_a)),
                             lunar_group_get_name (LUNAR_GROUP (group_b)));
}



static void
lunar_permissions_chooser_file_changed (LunarPermissionsChooser *chooser)
{
  LunarFile        *file;
  LunarUserManager *user_manager;
  LunarFileMode     mode = 0;
  LunarGroup       *group = NULL;
  LunarUser        *user = NULL;
  GtkListStore      *store;
  GtkTreeIter        iter;
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      if (n_files == 0)
      ...
      else
        {
          ...
          if (user != NULL && user != lunar_file_get_user (file))
            user = NULL;

          if (group != NULL && group != lunar_file_get_group (file))
            group = NULL;
  ...
  file = LUNAR_FILE (chooser->files->data);

  /* allocate a new store for the group combo box */
  g_signal_handlers_block_by_func (G_OBJECT (chooser->group_combo), lunar_permissions_chooser_group_changed, chooser);
  store = gtk_list_store_new (LUNAR_PERMISSIONS_STORE_N_COLUMNS, G_TYPE_STRING, G_TYPE_UINT);
  ...
  if (G_LIKELY (user != NULL))
    {
      ...
      user_name = lunar_user_get_name (user);
  ...
  if (G_UNLIKELY (geteuid () == 0))
    {
      ...
      groups = lunar_user_manager_get_all_groups (user_manager);
  ...
  else
    {
      if (G_UNLIKELY (user == NULL && n_files > 1))
        {
          ...
          user_manager = lunar_user_manager_get_default ();
          user = lunar_user_manager_get_user_by_id (user_manager, geteuid ());
          g_object_unref (G_OBJECT (user_manager));
        }
      ...
      if (G_LIKELY (user != NULL))
        {
          groups = g_list_copy (lunar_user_get_groups (user));
  ...
  for (lp = groups, n = 0; lp != NULL; lp = lp->next)
    {
      ...
      if (group != NULL
          && lunar_group_get_id (groups->data) == lunar_group_get_id (group)
          && lp != groups && n == 0)
        {
          gtk_list_store_append (store, &iter);
          n += 1;
        }
      else if (lp != groups && lunar_group_get_id (lp->data) < 100 && n == 1)
        {
          gtk_list_store_append (store, &iter);
          n += 1;
        }
      ...
      gtk_list_store_set (store, &iter,
                          LUNAR_PERMISSIONS_STORE_COLUMN_NAME, lunar_group_get_name (lp->data),
                          LUNAR_PERMISSIONS_STORE_COLUMN_GID, lunar_group_get_id (lp->data),
                          -1);
  ...
  for (n = 0; n < G_N_ELEMENTS (chooser->access_combos); ++n)
    {
      g_signal_handlers_block_by_func (G_OBJECT (chooser->access_combos[n]), lunar_permissions_chooser_access_changed, chooser);
      ...
      g_signal_handlers_unblock_by_func (G_OBJECT (chooser->access_combos[n]), lunar_permissions_chooser_access_changed, chooser);

      g_object_unref (G_OBJECT (access_store));
    }

  /* update the program setting based on the mode (only visible for regular files) */
  g_signal_handlers_block_by_func (G_OBJECT (chooser->program_button), lunar_permissions_chooser_program_toggled, chooser);
  g_object_set (G_OBJECT (chooser->program_button), "visible", lunar_file_is_regular (file), NULL);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (chooser->program_button), (mode & 0111) != 0);
  g_signal_handlers_unblock_by_func (G_OBJECT (chooser->program_button), lunar_permissions_chooser_program_toggled, chooser);

  /* update the "inconsistent folder permissions" warning and the "fix permissions" button based on the mode */
  if (lunar_permissions_chooser_has_fixable_directory (chooser))
    {
  ...
  g_signal_handlers_unblock_by_func (G_OBJECT (chooser->group_combo), lunar_permissions_chooser_group_changed, chooser);
...
static void
lunar_permissions_chooser_group_changed (LunarPermissionsChooser *chooser,
                                          GtkWidget                *combo)
{
  GtkTreeModel *model;
  GtkTreeIter   iter;
  ...
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (chooser->group_combo == combo);
  _lunar_return_if_fail (GTK_IS_COMBO_BOX (combo));
  ...
  if (gtk_combo_box_get_active_iter (GTK_COMBO_BOX (combo), &iter))
    {
      ...
      gtk_tree_model_get (model, &iter, LUNAR_PERMISSIONS_STORE_COLUMN_GID, &gid, -1);

      /* ...and try to change the group to the new gid */
      lunar_permissions_chooser_change_group (chooser, gid);
    }
}
...
static void
lunar_permissions_chooser_program_toggled (LunarPermissionsChooser *chooser,
                                            GtkWidget                *button)
{
  LunarFileMode mode;

  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (chooser->program_button == button);
  _lunar_return_if_fail (GTK_IS_TOGGLE_BUTTON (button));
  ...
  lunar_permissions_chooser_change_mode (chooser, 0000, 0000, 0111, mode);
}



static void
lunar_permissions_chooser_fixperm_clicked (LunarPermissionsChooser *chooser,
                                            GtkWidget                *button)
{
  LunarFileMode mode;
  GtkWidget     *dialog;
  ...
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (chooser->fixperm_button == button);
  _lunar_return_if_fail (GTK_IS_BUTTON (button));
  _lunar_return_if_fail (lunar_permissions_chooser_has_fixable_directory (chooser));
      ...
      for (lp = chooser->files; lp != NULL; lp = lp->next)
        {
          ...
          mode = lunar_file_get_mode (LUNAR_FILE (lp->data));

          /* determine the new mode (making sure the owner can read/enter the folder) */
          mode = (LUNAR_FILE_MODE_USR_READ | LUNAR_FILE_MODE_USR_EXEC)
               | (((mode & LUNAR_FILE_MODE_GRP_READ) != 0) ? LUNAR_FILE_MODE_GRP_EXEC : 0)
               | (((mode & LUNAR_FILE_MODE_OTH_READ) != 0) ? LUNAR_FILE_MODE_OTH_EXEC : 0);

          file_list.prev = NULL;
          file_list.data = lunar_file_get_file (LUNAR_FILE (lp->data));
          file_list.next = NULL;

          /* try to allocate the new job */
          job = lunar_io_jobs_change_mode (&file_list,
                                            0511, mode, 0000, 0000, FALSE);

          /* handle the job */
          lunar_permissions_chooser_job_start (chooser, job, FALSE);
          g_object_unref (job);
        }
    }
}
...
lunar_permissions_chooser_job_ask (LunarPermissionsChooser *chooser,
                                    const gchar              *message,
                                    LunarJobResponse         choices,
                                    LunarJob                *job)
{
  ...
  _lunar_return_val_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser), LUNAR_JOB_RESPONSE_CANCEL);
  ...
  _lunar_return_val_if_fail (chooser->job == job, LUNAR_JOB_RESPONSE_CANCEL);
  ...
  return lunar_dialogs_show_job_ask (GTK_WINDOW (toplevel), message, choices);
}



static void
lunar_permissions_chooser_job_cancel (LunarPermissionsChooser *chooser)
{
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
...
static void
lunar_permissions_chooser_job_error (LunarPermissionsChooser *chooser,
                                      GError                   *error,
                                      LunarJob                *job)
{
  GtkWidget *toplevel;
  ...
  _lunar_return_if_fail (chooser->job == job);
  ...
  lunar_dialogs_show_job_error (GTK_WINDOW (toplevel), error);
}



static void
lunar_permissions_chooser_job_finished (LunarPermissionsChooser *chooser,
                                         LunarJob                *job)
{
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (LUNAR_IS_JOB (job));
  ...
  lunar_permissions_chooser_job_cancel (chooser);
}



static void
lunar_permissions_chooser_job_percent (LunarPermissionsChooser *chooser,
                                        gdouble                   percent,
                                        LunarJob                *job)
{
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
...
static void
lunar_permissions_chooser_job_start (LunarPermissionsChooser *chooser,
                                      LunarJob                *job,
                                      gboolean                  recursive)
{
  _lunar_return_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser));
  _lunar_return_if_fail (LUNAR_IS_JOB (job));
  _lunar_return_if_fail (chooser->job == NULL);

  /* take a reference to the job and connect signals */
  chooser->job = g_object_ref (job);
  g_signal_connect_swapped (job, "ask", G_CALLBACK (lunar_permissions_chooser_job_ask), chooser);
  g_signal_connect_swapped (job, "error", G_CALLBACK (lunar_permissions_chooser_job_error), chooser);
  g_signal_connect_swapped (job, "finished", G_CALLBACK (lunar_permissions_chooser_job_finished), chooser);

  /* don't connect percent for single file operations */
  if (G_UNLIKELY (recursive))
    g_signal_connect_swapped (job, "percent", G_CALLBACK (lunar_permissions_chooser_job_percent), chooser);
...
static gboolean
lunar_permissions_chooser_row_separator (GtkTreeModel *model,
                                          GtkTreeIter  *iter,
                                          gpointer      data)
{
  gchar *name;
  ...
  gtk_tree_model_get (model, iter, LUNAR_PERMISSIONS_STORE_COLUMN_NAME, &name, -1);
...
/**
 * lunar_permissions_chooser_get_files:
 * @chooser : a #LunarPermissionsChooser.
 *
 * Returns the #LunarFile's associated with the specified @chooser.
 *
 * Return value: the file associated with @chooser.
 **/
GList*
lunar_permissions_chooser_get_files (LunarPermissionsChooser *chooser)
{
  _lunar_return_val_if_fail (LUNAR_IS_PERMISSIONS_CHOOSER (chooser), NULL);
...
/**
 * lunar_permissions_chooser_set_files:
 * @chooser : a #LunarPermissionsChooser.
 * @files   : a list of #LunarFiles or %NULL.
 *
 * Associates @chooser with the specified @file.
 **/
void
lunar_permissions_chooser_set_files (LunarPermissionsChooser *chooser,
                                      GList                    *files)
{
  GList *lp;
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      g_signal_handlers_disconnect_by_func (G_OBJECT (lp->data), lunar_permissions_chooser_file_changed, chooser);
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      g_signal_connect_swapped (G_OBJECT (lp->data), "changed", G_CALLBACK (lunar_permissions_chooser_file_changed), chooser);
    }
...
/**
 * lunar_permissions_chooser_new:
 *
 * Allocates a new #LunarPermissionsChooser instance.
 *
 * Return value: the newly allocated #LunarPermissionsChooser.
 **/
GtkWidget*
lunar_permissions_chooser_new (void)
{
  return g_object_new (LUNAR_TYPE_PERMISSIONS_CHOOSER, NULL);
}
