...
#ifndef __LUNAR_GOBJECT_EXTENSIONS_H__
#define __LUNAR_GOBJECT_EXTENSIONS_H__
 ...
 * within Lunar and they will be tested during debug builds. Besides that
...
void   lunar_g_initialize_transformations (void);
gchar* lunar_g_strescape                  (const gchar *source);

G_END_DECLS;

#endif /* !__LUNAR_GOBJECT_EXTENSIONS_H__ */
