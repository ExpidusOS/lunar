...
static void           lunar_shortcuts_view_finalize                     (GObject                  *object);
static gboolean       lunar_shortcuts_view_button_press_event           (GtkWidget                *widget,
                                                                          GdkEventButton           *event);
static gboolean       lunar_shortcuts_view_button_release_event         (GtkWidget                *widget,
                                                                          GdkEventButton           *event);
static gboolean       lunar_shortcuts_view_key_release_event            (GtkWidget                *widget,
                                                                          GdkEventKey              *event);
static void           lunar_shortcuts_view_drag_begin                   (GtkWidget                *widget,
                                                                          GdkDragContext           *context);
static void           lunar_shortcuts_view_drag_data_received           (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          ...
                                                                          guint                     info,
                                                                          guint                     timestamp);
static gboolean       lunar_shortcuts_view_drag_drop                    (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          guint                     timestamp);
static gboolean       lunar_shortcuts_view_drag_motion                  (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          guint                     timestamp);
static void           lunar_shortcuts_view_drag_leave                   (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          guint                     timestamp);
static gboolean       lunar_shortcuts_view_popup_menu                   (GtkWidget                *widget);
static void           lunar_shortcuts_view_row_activated                (GtkTreeView              *tree_view,
                                                                          GtkTreePath              *path,
                                                                          GtkTreeViewColumn        *column);
static gboolean       lunar_shortcuts_view_selection_func               (GtkTreeSelection         *selection,
                                                                          GtkTreeModel             *model,
                                                                          GtkTreePath              *path,
                                                                          gboolean                  path_currently_selected,
                                                                          gpointer                  user_data);
static void           lunar_shortcuts_view_context_menu_visibility      (LunarShortcutsView      *view,
                                                                          GdkEventButton           *event,
                                                                          GtkTreeModel             *model);
static void           lunar_shortcuts_view_context_menu                 (LunarShortcutsView      *view,
                                                                          GdkEventButton           *event,
                                                                          GtkTreeModel             *model,
                                                                          GtkTreeIter              *iter);
static void           lunar_shortcuts_view_remove_activated             (GtkWidget                *item,
                                                                          GtkTreeModel             *model);
static void           lunar_shortcuts_view_editing_canceled             (GtkCellRenderer          *renderer,
                                                                          LunarShortcutsView      *view);
static void           lunar_shortcuts_view_rename_activated             (GtkWidget                *item,
                                                                          LunarShortcutsView      *view);
static void           lunar_shortcuts_view_renamed                      (GtkCellRenderer          *renderer,
                                                                          const gchar              *path_string,
                                                                          const gchar              *text,
                                                                          LunarShortcutsView      *view);
static GdkDragAction  lunar_shortcuts_view_compute_drop_actions         (LunarShortcutsView      *view,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
...
static GtkTreePath   *lunar_shortcuts_view_compute_drop_position        (LunarShortcutsView      *view,
                                                                          gint                      x,
                                                                          gint                      y);
static void           lunar_shortcuts_view_drop_uri_list                (LunarShortcutsView      *view,
                                                                          GList                    *path_list,
                                                                          GtkTreePath              *dst_path);
static void           lunar_shortcuts_view_open_clicked                 (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_open                         (LunarShortcutsView      *view,
                                                                          OpenTarget                open_in);
static void           lunar_shortcuts_view_open_in_new_window_clicked   (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_open_in_new_tab_clicked      (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_empty_trash                  (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_create_shortcut              (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_eject                        (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_mount                        (LunarShortcutsView      *view);
static void           lunar_shortcuts_view_unmount                      (LunarShortcutsView      *view);



struct _LunarShortcutsViewClass
{
  GtkTreeViewClass __parent__;
};

struct _LunarShortcutsView
{
...
G_DEFINE_TYPE_WITH_CODE (LunarShortcutsView, lunar_shortcuts_view, GTK_TYPE_TREE_VIEW,
                         G_IMPLEMENT_INTERFACE (LUNAR_TYPE_BROWSER, NULL))



static void
lunar_shortcuts_view_class_init (LunarShortcutsViewClass *klass)
{
  ...
  gobject_class->finalize = lunar_shortcuts_view_finalize;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->button_press_event = lunar_shortcuts_view_button_press_event;
  gtkwidget_class->button_release_event = lunar_shortcuts_view_button_release_event;
  gtkwidget_class->key_release_event = lunar_shortcuts_view_key_release_event;
  gtkwidget_class->drag_begin = lunar_shortcuts_view_drag_begin;
  gtkwidget_class->drag_data_received = lunar_shortcuts_view_drag_data_received;
  gtkwidget_class->drag_drop = lunar_shortcuts_view_drag_drop;
  gtkwidget_class->drag_motion = lunar_shortcuts_view_drag_motion;
  gtkwidget_class->drag_leave = lunar_shortcuts_view_drag_leave;
  gtkwidget_class->popup_menu = lunar_shortcuts_view_popup_menu;

  gtktree_view_class = GTK_TREE_VIEW_CLASS (klass);
  gtktree_view_class->row_activated = lunar_shortcuts_view_row_activated;

  /**
   * LunarShortcutsView:shortcut-activated:
   *
  ...
  /**
   * LunarShortcutsView:shortcut-activated-tab:
   *
...
static void
lunar_shortcuts_view_init (LunarShortcutsView *view)
{
  GtkTreeViewColumn *column;
  ...
  gtk_tree_view_set_tooltip_column (GTK_TREE_VIEW (view), LUNAR_SHORTCUTS_MODEL_COLUMN_TOOLTIP);
  ...
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "text", LUNAR_SHORTCUTS_MODEL_COLUMN_NAME,
                                       "visible", LUNAR_SHORTCUTS_MODEL_COLUMN_IS_HEADER,
                                       NULL);
  ...
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", LUNAR_SHORTCUTS_MODEL_COLUMN_IS_ITEM,
                                       NULL);
  ...
  gtk_tree_view_column_set_attributes (column, view->icon_renderer,
                                       "gicon", LUNAR_SHORTCUTS_MODEL_COLUMN_GICON,
                                       "file", LUNAR_SHORTCUTS_MODEL_COLUMN_FILE,
                                       "device", LUNAR_SHORTCUTS_MODEL_COLUMN_DEVICE,
                                       "visible", LUNAR_SHORTCUTS_MODEL_COLUMN_IS_ITEM,
                                       NULL);
   ...
   */
  endo_binding_new (G_OBJECT (view->preferences), "shortcuts-icon-size", G_OBJECT (view->icon_renderer), "size");
  endo_binding_new (G_OBJECT (view->preferences), "shortcuts-icon-emblems", G_OBJECT (view->icon_renderer), "emblems");

  /* allocate the text renderer (ellipsizing as required, but "File System" must fit) */
  renderer = g_object_new (GTK_TYPE_CELL_RENDERER_TEXT,
                           "ellipsize", PANGO_ELLIPSIZE_END,
                           NULL);
  g_signal_connect (G_OBJECT (renderer), "edited", G_CALLBACK (lunar_shortcuts_view_renamed), view);
  ...
  gtk_tree_view_column_pack_start (column, renderer, FALSE);
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", LUNAR_SHORTCUTS_MODEL_COLUMN_BUSY,
                                       "active", LUNAR_SHORTCUTS_MODEL_COLUMN_BUSY,
                                       "pulse", LUNAR_SHORTCUTS_MODEL_COLUMN_BUSY_PULSE,
                                       NULL);
  ...
  gtk_tree_view_column_pack_start (column, renderer, FALSE);
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", LUNAR_SHORTCUTS_MODEL_COLUMN_CAN_EJECT,
                                       NULL);
  ...
  gtk_tree_selection_set_select_function (selection, lunar_shortcuts_view_selection_func, NULL, NULL);
}



static void
lunar_shortcuts_view_finalize (GObject *object)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (object);
  ...
  (*G_OBJECT_CLASS (lunar_shortcuts_view_parent_class)->finalize) (object);
}



static gboolean
lunar_shortcuts_view_button_press_event (GtkWidget      *widget,
                                          GdkEventButton *event)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
  GtkTreeModel        *model;
  GtkTreePath         *path;
  GtkTreeIter          iter;
  gboolean             result;
  ...
  result = (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->button_press_event) (widget, event);
  ...
  if (gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (widget), event->x, event->y, &path, NULL, NULL, NULL))
          ...
          if (gtk_tree_model_get_iter (model, &iter, path))
            {
              ...
              lunar_shortcuts_view_context_menu (view, event, model, &iter);
          ...
          if (event->button == 1 && button_clicked)
            {
              ...
              if (gtk_tree_model_get_iter (model, &iter, path))
                {
                  gtk_tree_model_get (model, &iter, LUNAR_SHORTCUTS_MODEL_COLUMN_CAN_EJECT, &can_eject, -1);
                  if (can_eject)
    ...
    {
      lunar_shortcuts_view_context_menu_visibility (view, event, model);
      result = TRUE;
    }
...
static gboolean
lunar_shortcuts_view_button_release_event (GtkWidget      *widget,
                                            GdkEventButton *event)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
  gboolean             in_tab;
  ...
  if (G_LIKELY (view->pressed_button == (gint) event->button))
    {
      ...
      if (view->pressed_eject_button)
        {
          lunar_shortcuts_view_eject (view);
        }
      else if (G_LIKELY (event->button == 1))
        {
          /* button 1 opens in the same window */
          lunar_shortcuts_view_open (view, OPEN_IN_VIEW);
        }
      else if (G_UNLIKELY (event->button == 2))
        {
          ...
          lunar_shortcuts_view_open (view, in_tab ? OPEN_IN_TAB : OPEN_IN_WINDOW);
        }
    }
  ...
  return (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->button_release_event) (widget, event);
}



static gboolean
lunar_shortcuts_view_key_release_event (GtkWidget   *widget,
                                         GdkEventKey *event)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
  ...
  /* call the parent's release event handler */
  return (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->key_release_event) (widget, event);
}



static void
lunar_shortcuts_view_drag_begin (GtkWidget      *widget,
                                  GdkDragContext *context)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
  ...
  if (GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->drag_begin != NULL)
    (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->drag_begin) (widget, context);
}



static void
lunar_shortcuts_view_drag_data_received (GtkWidget        *widget,
                                          GdkDragContext   *context,
                                          gint              x,
                                          gint              y,
                                          GtkSelectionData *selection_data,
                                          ...
                                          guint             timestamp)
{
  ...
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view));
  ...
  if (G_UNLIKELY (view->drop_occurred))
    {
      ...
      if (G_LIKELY (info == TEXT_URI_LIST))
        {
          ...
          actions = lunar_shortcuts_view_compute_drop_actions (view, context, x, y, &path, &action, &position);
              ...
              if (position == GTK_TREE_VIEW_DROP_BEFORE || position == GTK_TREE_VIEW_DROP_AFTER)
                {
                  ...
                  lunar_shortcuts_view_drop_uri_list (view, view->drop_file_list, path);
                }
                  ...
                  if (gtk_tree_model_get_iter (model, &iter, path))
                    {
                      ...
                      gtk_tree_model_get (model, &iter, LUNAR_SHORTCUTS_MODEL_COLUMN_FILE, &file, -1);
                      if (G_LIKELY (file != NULL))
                        {
                          /* ask the user what to do with the drop data */
                          if (G_UNLIKELY (action == GDK_ACTION_ASK))
                            action = lunar_dnd_ask (widget, file, view->drop_file_list, actions);

                          /* perform the requested action */
                          if (G_LIKELY (action != 0))
                            {
                              /* really perform the drop :-) */
                              succeed = lunar_dnd_perform (widget, file, view->drop_file_list, action, NULL);
                            }
      ...
      lunar_shortcuts_view_drag_leave (widget, context, timestamp);
...
static gboolean
lunar_shortcuts_view_drag_drop (GtkWidget      *widget,
                                 GdkDragContext *context,
                                 gint            x,
                                 gint            y,
                                 guint           timestamp)
{
  ...
  _lunar_return_val_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view), FALSE);
  ...
  if (G_LIKELY (target == gdk_atom_intern_static_string ("text/uri-list")))
  ...
  else if (target == gdk_atom_intern_static_string ("GTK_TREE_MODEL_ROW"))
    {
      ...
      dst_path = lunar_shortcuts_view_compute_drop_position (view, x, y);
      ...
      if (gtk_tree_selection_get_selected (selection, &model, &iter))
        {
          ...
          /* perform the move */
          lunar_shortcuts_model_move (LUNAR_SHORTCUTS_MODEL (child_model), child_src_path, child_dst_path);
...
static gboolean
lunar_shortcuts_view_drag_motion (GtkWidget      *widget,
                                   GdkDragContext *context,
                                   gint            x,
                                   gint            y,
                                   guint           timestamp)
  ...
  if (target == gdk_atom_intern_static_string ("text/uri-list"))
    {
      ...
      if (G_UNLIKELY (!view->drop_data_ready))
        ...
        {
          /* compute the drop position */
          lunar_shortcuts_view_compute_drop_actions (view, context, x, y, &path, &action, &position);
        }
    }
  else if (target == gdk_atom_intern_static_string ("GTK_TREE_MODEL_ROW"))
    {
      ...
      path = lunar_shortcuts_view_compute_drop_position (view, x, y);
      if (path == NULL)
        return FALSE;
...
static void
lunar_shortcuts_view_drag_leave (GtkWidget      *widget,
                                  GdkDragContext *context,
                                  guint           timestamp)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
   ...
   * is reset to its default (https://bugzilla.expidus.org/show_bug.cgi?id=2498).
   */
  gtk_widget_queue_draw (widget);

  /* call the parent's handler */
  (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->drag_leave) (widget, context, timestamp);
}



static gboolean
lunar_shortcuts_view_popup_menu (GtkWidget *widget)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (widget);
  GtkTreeSelection    *selection;
  GtkTreeModel        *model;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      /* popup the context menu */
      lunar_shortcuts_view_context_menu (view, NULL, model, &iter);
      return TRUE;
    }
  else if (GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->popup_menu != NULL)
    {
      /* call the parent's "popup-menu" handler */
      return (*GTK_WIDGET_CLASS (lunar_shortcuts_view_parent_class)->popup_menu) (widget);
    }
...
static void
lunar_shortcuts_view_row_activated (GtkTreeView       *tree_view,
                                     GtkTreePath       *path,
                                     GtkTreeViewColumn *column)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (tree_view);

  /* call the parent's "row-activated" handler */
  if (GTK_TREE_VIEW_CLASS (lunar_shortcuts_view_parent_class)->row_activated != NULL)
    (*GTK_TREE_VIEW_CLASS (lunar_shortcuts_view_parent_class)->row_activated) (tree_view, path, column);
...
static gboolean
lunar_shortcuts_view_selection_func (GtkTreeSelection *selection,
                                      GtkTreeModel     *model,
                                      GtkTreePath      *path,
                                      gboolean          path_currently_selected,
                                      gpointer          user_data)
{
  ...
  gtk_tree_model_get (model, &iter, LUNAR_SHORTCUTS_MODEL_COLUMN_IS_HEADER, &is_header, -1);
  return !is_header;
}
...
static void
lunar_shortcuts_view_context_menu_visibility_toggled (GtkCheckMenuItem *item,
                                                       GtkTreeModel     *model)
{
  gboolean             hidden;
  GtkTreePath         *path;
  ...
  _lunar_return_if_fail (GTK_IS_CHECK_MENU_ITEM (item));
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_MODEL (model));

  row = g_object_get_data (G_OBJECT (item), I_("lunar-shortcuts-row"));
  path = gtk_tree_row_reference_get_path (row);
  if (G_LIKELY (path != NULL))
    {
      hidden = !gtk_check_menu_item_get_active (item);
      lunar_shortcuts_model_set_hidden (LUNAR_SHORTCUTS_MODEL (model), path, hidden);
      gtk_tree_path_free (path);
    }
}
...
static void
lunar_shortcuts_view_context_menu_visibility (LunarShortcutsView *view,
                                               GdkEventButton      *event,
                                               GtkTreeModel        *model)
{
  GtkTreeIter          iter;
  ...
  do
    {
      ...
      gtk_tree_model_get (GTK_TREE_MODEL (child_model), &iter,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_GROUP, &group,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_NAME, &label,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_VISIBLE, &visible,
                          -1);

      if ((group & LUNAR_SHORTCUT_GROUP_HEADER) != 0)
        {
          /* get the mask of the group */
          if ((group & LUNAR_SHORTCUT_GROUP_DEVICES) != 0)
            mask = LUNAR_SHORTCUT_GROUP_DEVICES;
          else if ((group & LUNAR_SHORTCUT_GROUP_PLACES) != 0)
            mask = LUNAR_SHORTCUT_GROUP_PLACES;
          else if ((group & LUNAR_SHORTCUT_GROUP_NETWORK) != 0)
            mask = LUNAR_SHORTCUT_GROUP_NETWORK;
          else
      ...
      else if ((group & mask) != 0)
        {
          ...
          g_object_set_data_full (G_OBJECT (mi), I_("lunar-shortcuts-row"),
                                  gtk_tree_row_reference_new (child_model, path),
                                  (GDestroyNotify) gtk_tree_row_reference_free);
          g_signal_connect (G_OBJECT (mi), "toggled",
            G_CALLBACK (lunar_shortcuts_view_context_menu_visibility_toggled), child_model);
          gtk_widget_show (mi);
        }
...
static void
lunar_shortcuts_view_context_menu (LunarShortcutsView *view,
                                    GdkEventButton      *event,
                                    GtkTreeModel        *model,
                                    GtkTreeIter         *iter)
{
  ...
  gtk_tree_model_get (model, iter,
                      LUNAR_SHORTCUTS_MODEL_COLUMN_FILE, &file,
                      LUNAR_SHORTCUTS_MODEL_COLUMN_DEVICE, &device,
                      LUNAR_SHORTCUTS_MODEL_COLUMN_MUTABLE, &mutable,
                      LUNAR_SHORTCUTS_MODEL_COLUMN_GROUP, &group,
                      -1);
...
G_GNUC_END_IGNORE_DEPRECATIONS
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_open_clicked), view);
...
G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_open_in_new_tab_clicked), view);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);

  /* append the "Open in New Window" menu action */
  item = gtk_menu_item_new_with_mnemonic (_("Open in New Window"));
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_open_in_new_window_clicked), view);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);

  switch (group)
    {
      case LUNAR_SHORTCUT_GROUP_DEVICES_VOLUMES:
        can_mount = lunar_device_can_mount (device);
        can_unmount = lunar_device_can_unmount (device);
        can_eject = lunar_device_can_eject (device);
        ...
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_mount), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

        /* append the "Unmount" item */
        item = gtk_menu_item_new_with_mnemonic (_("_Unmount"));
        gtk_widget_set_visible (item, can_unmount);
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_unmount), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        ...
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_eject), view);
        break;

      case LUNAR_SHORTCUT_GROUP_NETWORK_MOUNTS:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
...
G_GNUC_END_IGNORE_DEPRECATIONS
        gtk_widget_set_sensitive (item, mount_point != NULL && !lunar_shortcuts_model_has_bookmark (LUNAR_SHORTCUTS_MODEL (shortcuts_model), mount_point));
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_create_shortcut), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
...
G_GNUC_END_IGNORE_DEPRECATIONS
      ...
      case LUNAR_SHORTCUT_GROUP_DEVICES_MOUNTS:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        ...
        /* append the "Unmount" item */
        item = gtk_menu_item_new_with_mnemonic (_("_Unmount"));
        gtk_widget_set_sensitive (item, lunar_device_can_eject (device));
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_eject), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        break;

      case LUNAR_SHORTCUT_GROUP_PLACES_TRASH:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        ...
        gtk_widget_set_sensitive (item, (lunar_file_get_item_count (file) > 0));
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_empty_trash), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        break;
  ...
  if (G_LIKELY (file != NULL && !lunar_file_is_trashed (file)))
    {
      /* load the menu providers from the provider factory */
      providers = lunarx_provider_factory_list_providers (view->provider_factory, LUNARX_TYPE_MENU_PROVIDER);
      if (G_LIKELY (providers != NULL))
        {
          ...
          for (lp = providers; lp != NULL; lp = lp->next)
            {
              tmp = lunarx_menu_provider_get_folder_menu_items (lp->data, window, LUNARX_FILE_INFO (file));
          ...
          for (lp = items; lp != NULL; lp = lp->next)
            {
              item = lunar_gtk_menu_lunarx_menu_item_new (lp->data, GTK_MENU_SHELL (menu));
              gtk_widget_show (item);
            }
  ...
  if (group == LUNAR_SHORTCUT_GROUP_PLACES_BOOKMARKS)
    {
      /* append a menu separator */
      item = gtk_separator_menu_item_new ();
      gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
...
G_GNUC_END_IGNORE_DEPRECATIONS
      g_object_set_data_full (G_OBJECT (item), I_("lunar-shortcuts-row"),
                              gtk_tree_row_reference_new (model, path),
                              (GDestroyNotify) gtk_tree_row_reference_free);
      g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_remove_activated), model);
...
G_GNUC_END_IGNORE_DEPRECATIONS
      ...
      g_object_set_data_full (G_OBJECT (item), I_("lunar-shortcuts-row"),
                              gtk_tree_row_reference_new (model, path),
                              (GDestroyNotify) gtk_tree_row_reference_free);
      g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (lunar_shortcuts_view_rename_activated), view);
      gtk_widget_set_sensitive (item, mutable);
      gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
      gtk_widget_show (item);
    }
...
static void
lunar_shortcuts_view_remove_activated (GtkWidget    *item,
                                        GtkTreeModel *model)
{
  GtkTreeRowReference *row;
  GtkTreeModel        *child_model;
  ...
  if (G_LIKELY (path != NULL))
    {
      ...
      child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
      lunar_shortcuts_model_remove (LUNAR_SHORTCUTS_MODEL (child_model), child_path);
...
static void
lunar_shortcuts_view_editing_canceled (GtkCellRenderer     *renderer,
                                        LunarShortcutsView *view)
{
  g_object_set (G_OBJECT (renderer), "editable", FALSE, NULL);

  g_signal_handlers_disconnect_by_func (G_OBJECT (renderer),
                                       G_CALLBACK (lunar_shortcuts_view_editing_canceled),
                                       view);
}
...
static void
lunar_shortcuts_view_rename_activated (GtkWidget           *item,
                                        LunarShortcutsView *view)
{
  GtkTreeRowReference *row;
  GtkTreeViewColumn   *column;
  ...
  if (G_LIKELY (path != NULL))
    {
      ...
      g_signal_connect (G_OBJECT (renderer), "editing-canceled",
                        G_CALLBACK (lunar_shortcuts_view_editing_canceled), view);
...
static void
lunar_shortcuts_view_renamed (GtkCellRenderer     *renderer,
                               const gchar         *path_string,
                               const gchar         *text,
                               LunarShortcutsView *view)
{
  ...
  if (gtk_tree_model_get_iter_from_string (model, &iter, path_string))
    {
      ...
      lunar_shortcuts_model_rename (LUNAR_SHORTCUTS_MODEL (child_model), &child_iter, text);
    }
}
...
lunar_shortcuts_view_compute_drop_actions (LunarShortcutsView     *view,
                                            GdkDragContext          *context,
                                            gint                     x,
                                            gint                     y,
                                            GtkTreePath            **path_return,
          ...
          if (G_LIKELY (file != NULL))
            {
              ...
              actions = lunar_file_accepts_drop (file, view->drop_file_list, context, action_return);
              if (G_LIKELY (actions != 0))
                {
...
static GtkTreePath*
lunar_shortcuts_view_compute_drop_position (LunarShortcutsView *view,
                                             gint                 x,
                                             gint                 y)
{
  GtkTreeViewColumn *column;
  ...
  _lunar_return_val_if_fail (gtk_tree_view_get_model (GTK_TREE_VIEW (view)) != NULL, NULL);
  _lunar_return_val_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view), NULL);
  ...
  if (gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (view), x, y,
                                     &path, &column, &x, &y))
    {
      ...
      for (; gtk_tree_path_get_indices (path)[0] < n_rows; gtk_tree_path_next (path))
        {
          child_path = gtk_tree_model_filter_convert_path_to_child_path (GTK_TREE_MODEL_FILTER (model), path);
          result = lunar_shortcuts_model_drop_possible (LUNAR_SHORTCUTS_MODEL (child_model), child_path);
          gtk_tree_path_free (child_path);
          if (result)
            return path;
        }
...
static void
lunar_shortcuts_view_drop_uri_list (LunarShortcutsView *view,
                                     GList               *path_list,
                                     GtkTreePath         *dst_path)
{
  GtkTreeModel *model;
  ...
  for (lp = path_list; lp != NULL; lp = lp->next)
    {
      file = lunar_file_get (lp->data, &error);
      ...
      child_path = gtk_tree_model_filter_convert_path_to_child_path (GTK_TREE_MODEL_FILTER (model), path);
      lunar_shortcuts_model_add (LUNAR_SHORTCUTS_MODEL (child_model), child_path, file);
      gtk_tree_path_free (child_path);
  ...
  if (G_UNLIKELY (error != NULL))
    {
      ...
      lunar_dialogs_show_error (GTK_WIDGET (view), error, _("Failed to add new shortcut"));
...
static void
lunar_shortcuts_view_open_clicked (LunarShortcutsView *view)
{
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view));
  lunar_shortcuts_view_open (view, OPEN_IN_VIEW);
}
...
static void
lunar_shortcuts_view_poke_file_finish (LunarBrowser *browser,
                                        LunarFile    *file,
                                        ...
                                        gpointer       user_data)
{
  ...
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_VIEW (browser));
  _lunar_return_if_fail (LUNAR_IS_FILE (target_file));
  ...
  if (error == NULL)
    {
      if (open_in == OPEN_IN_WINDOW)
        {
          ...
          lunar_application_open_window (application, target_file,
      ...
      else if (lunar_file_check_loaded (target_file))
        {
    ...
    {
      lunar_dialogs_show_error (GTK_WIDGET (browser), error, _("Failed to open \"%s\""),
                                 lunar_file_get_display_name (file));
    }
}
...
static void
lunar_shortcuts_view_poke_location_finish (LunarBrowser *browser,
                                            GFile         *location,
                                            LunarFile    *file,
                                            LunarFile    *target_file,
                                            GError        *error,
                                            gpointer       user_data)
{
  ...
  if (error == NULL)
    {
      lunar_shortcuts_view_poke_file_finish (browser, file, target_file, error, user_data);
    }
  else
    {
      name = lunar_g_file_get_display_name_remote (location);
      lunar_dialogs_show_error (GTK_WIDGET (browser), error, _("Failed to open \"%s\""), name);
      g_free (name);
    }
}
...
static void
lunar_shortcuts_view_poke_device_finish (LunarBrowser *browser,
                                          LunarDevice  *device,
                                          ...
                                          gboolean       cancelled)
{
  ...
  if (cancelled)
    ...
    {
      lunar_browser_poke_file (browser, mount_point, GTK_WIDGET (browser),
                                lunar_shortcuts_view_poke_file_finish,
                                user_data);
    }
  else
    {
  ...
  child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
  lunar_shortcuts_model_set_busy (LUNAR_SHORTCUTS_MODEL (child_model), device, FALSE);
}



static void
lunar_shortcuts_view_open (LunarShortcutsView *view,
                            OpenTarget           open_in)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      gtk_tree_model_get (model, &iter,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_FILE, &file,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_DEVICE, &device,
                          LUNAR_SHORTCUTS_MODEL_COLUMN_LOCATION, &location,
                          -1);

      if (G_LIKELY (LUNAR_IS_DEVICE (device)))
        {
          /* start the spinner */
          child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
          lunar_shortcuts_model_set_busy (LUNAR_SHORTCUTS_MODEL (child_model), device, TRUE);

          lunar_browser_poke_device (LUNAR_BROWSER (view), device, view,
                                      lunar_shortcuts_view_poke_device_finish,
                                      GUINT_TO_POINTER (open_in));
        }
      else if (file != NULL)
        {
          lunar_browser_poke_file (LUNAR_BROWSER (view), file, view,
                                    lunar_shortcuts_view_poke_file_finish,
                                    GUINT_TO_POINTER (open_in));
        }
      else if (location != NULL)
        {
          lunar_browser_poke_location (LUNAR_BROWSER (view), location, view,
                                        lunar_shortcuts_view_poke_location_finish,
                                        GUINT_TO_POINTER (open_in));
        }
...
static void
lunar_shortcuts_view_open_in_new_window_clicked (LunarShortcutsView *view)
{
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view));
  lunar_shortcuts_view_open (view, OPEN_IN_WINDOW);
}



static void
lunar_shortcuts_view_open_in_new_tab_clicked (LunarShortcutsView *view)
{
  _lunar_return_if_fail (LUNAR_IS_SHORTCUTS_VIEW (view));
  lunar_shortcuts_view_open (view, OPEN_IN_TAB);
}



static void
lunar_shortcuts_view_empty_trash (LunarShortcutsView *view)
{
  LunarApplication *application;
  ...
  application = lunar_application_get ();
  lunar_application_empty_trash (application, GTK_WIDGET (view), NULL);
...
static void
lunar_shortcuts_view_create_shortcut (LunarShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      gtk_tree_model_get (model, &iter, LUNAR_SHORTCUTS_MODEL_COLUMN_DEVICE, &device, -1);
      ...
      if (G_LIKELY (LUNAR_IS_DEVICE (device)))
        {
          ...
          if (mount_point != NULL)
            {
              shortcuts_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
              lunar_shortcuts_model_add (LUNAR_SHORTCUTS_MODEL (shortcuts_model), NULL, mount_point);
              g_object_unref (mount_point);
            }
...
static void
lunar_shortcuts_view_eject_finish (LunarDevice *device,
                                    const GError *error,
                                    gpointer      user_data)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (user_data);
  gchar               *device_name;
  GtkTreeModel        *model;
  GtkTreeModel        *child_model;
  ...
  if (error != NULL)
    {
      ...
      device_name = lunar_device_get_name (device);
      lunar_dialogs_show_error (GTK_WIDGET (view), error, _("Failed to eject \"%s\""), device_name);
      g_free (device_name);
    }
...
static void
lunar_shortcuts_view_eject (LunarShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
      ...
      if (G_LIKELY (LUNAR_IS_DEVICE (device)))
        {
          ...
          mount_operation = lunar_gtk_mount_operation_new (GTK_WIDGET (view));
          ...
          /* try to unmount */
          lunar_device_eject (device,
                               mount_operation,
                               NULL,
                               lunar_shortcuts_view_eject_finish,
                               g_object_ref (view));
...
static void
lunar_shortcuts_view_poke_device_mount_finish (LunarBrowser *browser,
                                                LunarDevice  *device,
                                                LunarFile    *mount_point,
                                                GError        *error,
                                                gpointer       ignored,
...
static void
lunar_shortcuts_view_mount (LunarShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
      ...
      if (G_LIKELY (LUNAR_IS_DEVICE (device)))
        {
          ...
          lunar_browser_poke_device (LUNAR_BROWSER (view), device, view,
                                      (LunarBrowserPokeDeviceFunc)lunar_shortcuts_view_poke_device_mount_finish,
                                      NULL);
          g_object_unref (device);
        }
    }
...
static void
lunar_shortcuts_view_unmount_finish (LunarDevice *device,
                                      const GError *error,
                                      gpointer      user_data)
{
  LunarShortcutsView *view = LUNAR_SHORTCUTS_VIEW (user_data);
  ...
  if (error != NULL)
    {
      /* display an error dialog to inform the user */
      device_name = lunar_device_get_name (device);
      lunar_dialogs_show_error (GTK_WIDGET (view), error, _("Failed to unmount \"%s\""), device_name);
      g_free (device_name);
    }
...
static void
lunar_shortcuts_view_unmount (LunarShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
      ...
      if (G_LIKELY (LUNAR_IS_DEVICE (device)))
        {
          ...
          /* try to unmount */
          lunar_device_unmount (device,
                                 mount_operation,
                                 NULL,
                                 lunar_shortcuts_view_unmount_finish,
                                 g_object_ref (view));
...
/**
 * lunar_shortcuts_view_new:
 *
 * Allocates a new #LunarShortcutsView instance and associates
 * it with the default #LunarShortcutsModel instance.
 *
 * Return value: the newly allocated #LunarShortcutsView instance.
 **/
GtkWidget*
lunar_shortcuts_view_new (void)
{
  LunarShortcutsModel *model;
  GtkWidget            *view;
  GtkTreeModel         *filter_model;

  model = lunar_shortcuts_model_get_default ();
  filter_model = gtk_tree_model_filter_new (GTK_TREE_MODEL (model), NULL);
  gtk_tree_model_filter_set_visible_column (GTK_TREE_MODEL_FILTER (filter_model), LUNAR_SHORTCUTS_MODEL_COLUMN_VISIBLE);
  g_object_unref (G_OBJECT (model));

  view = g_object_new (LUNAR_TYPE_SHORTCUTS_VIEW, "model", filter_model, NULL);
...
/**
 * lunar_shortcuts_view_select_by_file:
 * @view : a #LunarShortcutsView instance.
 * @file : a #LunarFile instance.
 *
 * Looks up the first shortcut that refers to @file in @view and selects it.
 * If @file is not present in the underlying #LunarShortcutsModel, no
 * shortcut will be selected afterwards.
 **/
void
lunar_shortcuts_view_select_by_file (LunarShortcutsView *view,
                                      LunarFile          *file)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  ...
  if (lunar_shortcuts_model_iter_for_file (LUNAR_SHORTCUTS_MODEL (child_model), file, &child_iter)
...
void
lunar_shortcuts_view_toggle_padding (LunarShortcutsView *view,
                                      gboolean             enable)
{
