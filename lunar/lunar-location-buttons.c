...
#include <lunar/lunar-location-button.h>
...
#define LUNAR_LOCATION_BUTTONS_SCROLL_TIMEOUT  (200)
...
static void           lunar_location_buttons_navigator_init              (LunarNavigatorIface       *iface);
static void           lunar_location_buttons_finalize                    (GObject                    *object);
static void           lunar_location_buttons_get_property                (GObject                    *object,
                                                                           guint                       prop_id,
                                                                           GValue                     *value,
                                                                           GParamSpec                 *pspec);
static void           lunar_location_buttons_set_property                (GObject                    *object,
                                                                           guint                       prop_id,
                                                                           const GValue               *value,
                                                                           GParamSpec                 *pspec);
static LunarFile    *lunar_location_buttons_get_current_directory       (LunarNavigator            *navigator);
static void           lunar_location_buttons_set_current_directory       (LunarNavigator            *navigator,
                                                                           LunarFile                 *current_directory);
static void           lunar_location_buttons_unmap                       (GtkWidget                  *widget);
static void           lunar_location_buttons_on_filler_clicked           (LunarLocationButtons      *buttons);
static void           lunar_location_buttons_get_preferred_width         (GtkWidget                  *widget,
                                                                           gint                       *minimum,
                                                                           gint                       *natural);
static void           lunar_location_buttons_get_preferred_height        (GtkWidget                  *widget,
                                                                           gint                       *minimum,
                                                                           gint                       *natural);
static GtkWidgetPath *lunar_location_buttons_get_path_for_child          (GtkContainer               *container,
                                                                           GtkWidget                  *child);
static void           lunar_location_buttons_child_ordering_changed      (LunarLocationButtons      *buttons);
static GList         *lunar_location_buttons_detect_first_visible_button (LunarLocationButtons      *buttons,
                                                                           gint                        available_width,
                                                                           gint                       *resulting_occupied_width);
static GList         *lunar_location_buttons_detect_last_visible_button  (LunarLocationButtons      *buttons,
                                                                           gint                        available_width,
                                                                           gint                       *resulting_occupied_width);
static void           lunar_location_buttons_size_allocate               (GtkWidget                  *widget,
                                                                           GtkAllocation              *allocation);
static void           lunar_location_buttons_state_changed               (GtkWidget                  *widget,
                                                                           GtkStateType                previous_state);
static void           lunar_location_buttons_grab_notify                 (GtkWidget                  *widget,
                                                                           gboolean                    was_grabbed);
static void           lunar_location_buttons_add                         (GtkContainer               *container,
                                                                           GtkWidget                  *widget);
static void           lunar_location_buttons_remove                      (GtkContainer               *container,
                                                                           GtkWidget                  *widget);
static void           lunar_location_buttons_forall                      (GtkContainer               *container,
                                                                           gboolean                    include_internals,
                                                                           GtkCallback                 callback,
                                                                           gpointer                    callback_data);
static GtkWidget     *lunar_location_buttons_make_button                 (LunarLocationButtons      *buttons,
                                                                           LunarFile                 *file);
static void           lunar_location_buttons_remove_1                    (GtkContainer               *container,
                                                                           GtkWidget                  *widget);
static gboolean       lunar_location_buttons_draw                        (GtkWidget                  *buttons,
                                                                           cairo_t                    *cr);
static gboolean       lunar_location_buttons_scroll_timeout              (gpointer                    user_data);
static void           lunar_location_buttons_scroll_timeout_destroy      (gpointer                    user_data);
static void           lunar_location_buttons_stop_scrolling              (LunarLocationButtons      *buttons);
static void           lunar_location_buttons_update_sliders              (LunarLocationButtons      *buttons);
static gboolean       lunar_location_buttons_slider_button_press         (GtkWidget                  *button,
                                                                           GdkEventButton             *event,
                                                                           LunarLocationButtons      *buttons);
static gboolean       lunar_location_buttons_slider_button_release       (GtkWidget                  *button,
                                                                           GdkEventButton             *event,
                                                                           LunarLocationButtons      *buttons);
static void           lunar_location_buttons_scroll_left                 (GtkWidget                  *button,
                                                                           LunarLocationButtons      *buttons);
static void           lunar_location_buttons_scroll_right                (GtkWidget                  *button,
                                                                           LunarLocationButtons      *buttons);
static void           lunar_location_buttons_clicked                     (LunarLocationButton       *button,
                                                                           gboolean                    open_in_tab,
                                                                           LunarLocationButtons      *buttons);
static gboolean       lunar_location_buttons_context_menu                (LunarLocationButton       *button,
                                                                           LunarLocationButtons      *buttons);
static void           lunar_location_buttons_gone                        (LunarLocationButton       *button,
                                                                           LunarLocationButtons      *buttons);



struct _LunarLocationButtonsClass
{
...
static GQuark lunar_file_quark = 0;



G_DEFINE_TYPE_WITH_CODE (LunarLocationButtons, lunar_location_buttons, GTK_TYPE_CONTAINER,
    G_IMPLEMENT_INTERFACE (LUNAR_TYPE_NAVIGATOR, lunar_location_buttons_navigator_init))



static void
lunar_location_buttons_class_init (LunarLocationButtonsClass *klass)
{
  ...
  gobject_class->finalize = lunar_location_buttons_finalize;
  gobject_class->get_property = lunar_location_buttons_get_property;
  gobject_class->set_property = lunar_location_buttons_set_property;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->draw = lunar_location_buttons_draw;
  gtkwidget_class->unmap = lunar_location_buttons_unmap;
  gtkwidget_class->get_preferred_width = lunar_location_buttons_get_preferred_width;
  gtkwidget_class->get_preferred_height = lunar_location_buttons_get_preferred_height;
  gtkwidget_class->size_allocate = lunar_location_buttons_size_allocate;
  gtkwidget_class->state_changed = lunar_location_buttons_state_changed;
  gtkwidget_class->grab_notify = lunar_location_buttons_grab_notify;

  gtkcontainer_class = GTK_CONTAINER_CLASS (klass);
  gtkcontainer_class->add = lunar_location_buttons_add;
  gtkcontainer_class->remove = lunar_location_buttons_remove;
  gtkcontainer_class->forall = lunar_location_buttons_forall;
  gtkcontainer_class->get_path_for_child = lunar_location_buttons_get_path_for_child;
  ...
  g_signal_new ("entry-requested",
                ...
                G_SIGNAL_RUN_LAST,
                G_STRUCT_OFFSET (LunarLocationButtonsClass, entry_requested),
                NULL, NULL,
                NULL,
                G_TYPE_NONE,
                1,
  ...
  lunar_file_quark = g_quark_from_static_string ("button-lunar-file");
}


static void
lunar_location_buttons_navigator_init (LunarNavigatorIface *iface)
{
  iface->get_current_directory = lunar_location_buttons_get_current_directory;
  iface->set_current_directory = lunar_location_buttons_set_current_directory;
}



static void
lunar_location_buttons_on_filler_clicked (LunarLocationButtons *buttons)
{
...
static void
lunar_location_buttons_init (LunarLocationButtons *buttons)
{
  GtkWidget       *icon;
  ...
  g_signal_connect (G_OBJECT (buttons->left_slider), "button-press-event", G_CALLBACK (lunar_location_buttons_slider_button_press), buttons);
  g_signal_connect (G_OBJECT (buttons->left_slider), "button-release-event", G_CALLBACK (lunar_location_buttons_slider_button_release), buttons);
  g_signal_connect (G_OBJECT (buttons->left_slider), "clicked", G_CALLBACK (lunar_location_buttons_scroll_left), buttons);
  ...
  g_signal_connect (G_OBJECT (buttons->right_slider), "button-press-event", G_CALLBACK (lunar_location_buttons_slider_button_press), buttons);
  g_signal_connect (G_OBJECT (buttons->right_slider), "button-release-event", G_CALLBACK (lunar_location_buttons_slider_button_release), buttons);
  g_signal_connect (G_OBJECT (buttons->right_slider), "clicked", G_CALLBACK (lunar_location_buttons_scroll_right), buttons);
  ...
  g_signal_connect_swapped (buttons->filler_widget, "clicked", G_CALLBACK (lunar_location_buttons_on_filler_clicked), buttons);
  ...
  buttons->launcher =  g_object_new (LUNAR_TYPE_LAUNCHER, "widget", GTK_WIDGET (buttons), NULL);
  g_signal_connect_swapped (G_OBJECT (buttons->launcher), "change-directory", G_CALLBACK (lunar_location_buttons_set_current_directory), buttons);
  g_signal_connect_swapped (G_OBJECT (buttons->launcher), "open-new-tab", G_CALLBACK (lunar_navigator_open_new_tab), buttons);
}



static void
lunar_location_buttons_finalize (GObject *object)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (object);

  _lunar_return_if_fail (LUNAR_IS_LOCATION_BUTTONS (buttons));

  /* be sure to cancel the scrolling */
  lunar_location_buttons_stop_scrolling (buttons);

  /* release from the current_directory */
  lunar_navigator_set_current_directory (LUNAR_NAVIGATOR (buttons), NULL);

  (*G_OBJECT_CLASS (lunar_location_buttons_parent_class)->finalize) (object);
}



static void
lunar_location_buttons_get_property (GObject    *object,
                                      guint       prop_id,
                                      GValue     *value,
                                      GParamSpec *pspec)
{
...
static void
lunar_location_buttons_set_property (GObject      *object,
                                      guint         prop_id,
                                      const GValue *value,
                                      GParamSpec   *pspec)
{
...
static LunarFile*
lunar_location_buttons_get_current_directory (LunarNavigator *navigator)
{
  return LUNAR_LOCATION_BUTTONS (navigator)->current_directory;
}



static inline gboolean
eglible_for_fake_root (LunarFile *file)
{
  /* use 'Home' as fake root button */
  return lunar_file_is_home (file);
...
static void
lunar_location_buttons_set_current_directory (LunarNavigator *navigator,
                                               LunarFile      *current_directory)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (navigator);
  ...
  for (lp = buttons->list; lp != NULL; lp = lp->next)
    {
      if (lunar_location_button_get_file (lp->data) == current_directory)
        {
  ...
  if (G_LIKELY (current_directory != NULL))
    {
      ...
      for (file = current_directory; file != NULL; file = file_parent)
        {
          button = lunar_location_buttons_make_button (buttons, file);
...
static void
lunar_location_buttons_unmap (GtkWidget *widget)
{
  /* be sure to stop the scroll timer before the buttons are unmapped */
  lunar_location_buttons_stop_scrolling (LUNAR_LOCATION_BUTTONS (widget));

  /* do the real unmap */
  (*GTK_WIDGET_CLASS (lunar_location_buttons_parent_class)->unmap) (widget);
}



static void
lunar_location_buttons_get_preferred_width (GtkWidget  *widget,
                                             gint       *minimum,
                                             gint       *natural)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (widget);
...
static void
lunar_location_buttons_get_preferred_height (GtkWidget *widget,
                                              gint      *minimum,
                                              gint      *natural)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (widget);
...
lunar_location_buttons_get_path_for_child (GtkContainer *container,
                                            GtkWidget    *child)
{
  LunarLocationButtons *path_bar = LUNAR_LOCATION_BUTTONS (container);
  GtkWidgetPath *path;
...
static void
lunar_location_buttons_child_ordering_changed (LunarLocationButtons *location_buttons)
{
...
static GList*
lunar_location_buttons_detect_first_visible_button (LunarLocationButtons *buttons,
                                                     gint                   available_width,
                                                     gint                  *resulting_occupied_width)
{
  GList *lp;
...
static GList*
lunar_location_buttons_detect_last_visible_button (LunarLocationButtons *buttons,
                                                    gint                   available_width,
                                                    gint                  *resulting_occupied_width)
{
  GList *lp;
...
static void
lunar_location_buttons_size_allocate (GtkWidget     *widget,
                                       GtkAllocation *allocation)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (widget);
  ...
  if ( required_width_total <= available_space.width  )
  ...
  else
    {
      ...
      if(buttons->first_visible_button == NULL) /* last button is fixed defined */
        buttons->first_visible_button = lunar_location_buttons_detect_first_visible_button(buttons, available_space.width - required_width_total, &temp_width);
      else                                      /* first button is fixed defined */
        buttons->last_visible_button = lunar_location_buttons_detect_last_visible_button(buttons, available_space.width - required_width_total, &temp_width);
  ...
  lunar_location_buttons_update_sliders (buttons);

  if (need_reorder)
    lunar_location_buttons_child_ordering_changed (buttons);
...
static gboolean
lunar_location_buttons_draw (GtkWidget *widget,
                              cairo_t   *cr)
{
  ...
  return GTK_WIDGET_CLASS (lunar_location_buttons_parent_class)->draw (widget, cr);
}



static void
lunar_location_buttons_state_changed (GtkWidget   *widget,
                                       GtkStateType previous_state)
{
...
static void
lunar_location_buttons_grab_notify (GtkWidget *widget,
                                     gboolean   was_grabbed)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (widget);
...
static void
lunar_location_buttons_add (GtkContainer *container,
                             GtkWidget    *widget)
{
...
static void
lunar_location_buttons_remove (GtkContainer *container,
                                GtkWidget    *widget)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (container);
  GList                 *lp;

  if (widget == buttons->left_slider)
    {
      lunar_location_buttons_remove_1 (container, widget);
...
static void
lunar_location_buttons_forall (GtkContainer *container,
                                gboolean      include_internals,
                                GtkCallback   callback,
                                gpointer      callback_data)
{
...
static GtkWidget*
lunar_location_buttons_make_button (LunarLocationButtons *buttons,
                                     LunarFile            *file)
{
  GtkWidget *button;

  /* allocate the button */
  button = lunar_location_button_new ();

  /* connect to the file */
  lunar_location_button_set_file (LUNAR_LOCATION_BUTTON (button), file);

  /* the current directory is active */
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (button), (file == buttons->current_directory));

  /* connect signal handlers */
  g_signal_connect (G_OBJECT (button), "location-button-clicked", G_CALLBACK (lunar_location_buttons_clicked), buttons);
  g_signal_connect (G_OBJECT (button), "gone", G_CALLBACK (lunar_location_buttons_gone), buttons);
  g_signal_connect (G_OBJECT (button), "popup-menu", G_CALLBACK (lunar_location_buttons_context_menu), buttons);
...
static void
lunar_location_buttons_remove_1 (GtkContainer *container,
                                  GtkWidget    *widget)
{
...
static gboolean
lunar_location_buttons_scroll_timeout (gpointer user_data)
{
  LunarLocationButtons *buttons = LUNAR_LOCATION_BUTTONS (user_data);

  if (gtk_widget_has_focus (buttons->left_slider))
    lunar_location_buttons_scroll_left (buttons->left_slider, buttons);
  else if (gtk_widget_has_focus (buttons->right_slider))
    lunar_location_buttons_scroll_right (buttons->right_slider, buttons);
...
static void
lunar_location_buttons_scroll_timeout_destroy (gpointer user_data)
{
  LUNAR_LOCATION_BUTTONS (user_data)->scroll_timeout_id = 0;
}



static void
lunar_location_buttons_stop_scrolling (LunarLocationButtons *buttons)
{
...
static void
lunar_location_buttons_update_sliders (LunarLocationButtons *buttons)
{
  GtkWidget *button;
...
static gboolean
lunar_location_buttons_slider_button_press (GtkWidget             *button,
                                             GdkEventButton        *event,
                                             LunarLocationButtons *buttons)
{
  ...
  if (button == buttons->left_slider)
    lunar_location_buttons_scroll_left (button, buttons);
  else if (button == buttons->right_slider)
    lunar_location_buttons_scroll_right (button, buttons);

  if (G_LIKELY (buttons->scroll_timeout_id == 0))
    {
      buttons->scroll_timeout_id = gdk_threads_add_timeout_full (G_PRIORITY_LOW,
                                                                 LUNAR_LOCATION_BUTTONS_SCROLL_TIMEOUT,
                                                                 lunar_location_buttons_scroll_timeout, buttons,
                                                                 lunar_location_buttons_scroll_timeout_destroy);
    }
...
static gboolean
lunar_location_buttons_slider_button_release (GtkWidget             *button,
                                               GdkEventButton        *event,
                                               LunarLocationButtons *buttons)
{
...
static void
lunar_location_buttons_scroll_left (GtkWidget             *button,
                                     LunarLocationButtons *buttons)
{
...
static void
lunar_location_buttons_scroll_right (GtkWidget             *button,
                                      LunarLocationButtons *buttons)
{
  if (G_UNLIKELY (buttons->ignore_click))
    {
...
static void
lunar_location_buttons_clicked (LunarLocationButton  *button,
                                 gboolean               open_in_tab,
                                 LunarLocationButtons *buttons)
{
  LunarFile *directory;
  ...
  _lunar_return_if_fail (LUNAR_IS_LOCATION_BUTTON (button));
  _lunar_return_if_fail (LUNAR_IS_LOCATION_BUTTONS (buttons));

  /* determine the directory associated with the clicked button */
  directory = lunar_location_button_get_file (button);

  /* open in tab */
  if (open_in_tab)
    {
      lunar_navigator_open_new_tab (LUNAR_NAVIGATOR (buttons), directory);
      return;
    }
  ...
  for (lp = buttons->list; lp != NULL; lp = lp->next)
    {
      ...
      button = LUNAR_LOCATION_BUTTON (lp->data);
      directory = lunar_location_button_get_file (button);

      /* update the location button state (making sure to not recurse with the "clicked" handler) */
      g_signal_handlers_block_by_func (G_OBJECT (button), lunar_location_buttons_clicked, buttons);
      gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (button), directory == buttons->current_directory);
      g_signal_handlers_unblock_by_func (G_OBJECT (button), lunar_location_buttons_clicked, buttons);
    }

  /* notify the surrounding module that we want to change to a different directory.  */
  lunar_navigator_change_directory (LUNAR_NAVIGATOR (buttons), buttons->current_directory);
}



static void
lunar_location_buttons_gone (LunarLocationButton  *button,
                              LunarLocationButtons *buttons)
{
  _lunar_return_if_fail (LUNAR_IS_LOCATION_BUTTON (button));
  _lunar_return_if_fail (LUNAR_IS_LOCATION_BUTTONS (buttons));
  _lunar_return_if_fail (g_list_find (buttons->list, button) != NULL);
...
static gboolean
lunar_location_buttons_context_menu (LunarLocationButton  *button,
                                      LunarLocationButtons *buttons)
{
  LunarFile *file;
  GtkWidget  *window;
  ...
  _lunar_return_val_if_fail (LUNAR_IS_LOCATION_BUTTONS (buttons), FALSE);
  _lunar_return_val_if_fail (LUNAR_IS_LOCATION_BUTTON (button), FALSE);

  /* determine the file for the button */
  file = lunar_location_button_get_file (button);
  ...
  g_list_free (files);
  is_current_directory = g_file_equal (lunar_file_get_file (file), lunar_file_get_file (buttons->current_directory));
  context_menu = g_object_new (LUNAR_TYPE_MENU, "menu-type", LUNAR_MENU_TYPE_CONTEXT_LOCATION_BUTTONS,
