  ...
  if (g_once_init_enter (&type__volatile))
    {
      ...
      /**
       * LunarxFileInfo::changed:
       * @file_info : a #LunarxFileInfo.
       *
       * Emitted whenever the system notices a change to @file_info.
       *
       * Lunar plugins should use this signal to stay informed about
       * changes to a @file_info for which they currently display
       * information (i.e. in a #LunarxPropertyPage), and update
      ...
      file_info_signals[CHANGED] =
        g_signal_new (I_("changed"),
                      type,
                      G_SIGNAL_RUN_FIRST,
                      G_STRUCT_OFFSET (LunarxFileInfoIface, changed),
                      NULL, NULL,
                      g_cclosure_marshal_VOID__VOID,
                      G_TYPE_NONE, 0);

      /**
       * LunarxFileInfo::renamed:
       * @file_info : a #LunarxFileInfo
       *
       * Emitted when the @file_info is renamed to another
       * name.
       *
       * For example, within Lunar, #LunarFolder uses this
      ...
      file_info_signals[RENAMED] =
        g_signal_new (I_("renamed"),
                      type,
                      G_SIGNAL_RUN_FIRST,
                      G_STRUCT_OFFSET (LunarxFileInfoIface, renamed),
                      NULL, NULL,
                      g_cclosure_marshal_VOID__VOID,
                      G_TYPE_NONE, 0);
 ...
 **/
gchar*
lunarx_file_info_get_name (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_name) (file_info);
}



/**
 * lunarx_file_info_get_uri:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
gchar*
lunarx_file_info_get_uri (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_uri) (file_info);
}



/**
 * lunarx_file_info_get_parent_uri:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
gchar*
lunarx_file_info_get_parent_uri (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_parent_uri) (file_info);
}



/**
 * lunarx_file_info_get_uri_scheme:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
gchar*
lunarx_file_info_get_uri_scheme (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_uri_scheme) (file_info);
}



/**
 * lunarx_file_info_get_mime_type:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
gchar*
lunarx_file_info_get_mime_type (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_mime_type) (file_info);
}



/**
 * lunarx_file_info_has_mime_type:
 * @file_info : a #LunarxFileInfo.
 ...
 **/
gboolean
lunarx_file_info_has_mime_type (LunarxFileInfo *file_info,
                                 const gchar     *mime_type)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), FALSE);
  g_return_val_if_fail (mime_type != NULL, FALSE);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->has_mime_type) (file_info, mime_type);
}



/**
 * lunarx_file_info_is_directory:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
gboolean
lunarx_file_info_is_directory (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), FALSE);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->is_directory) (file_info);
}
 ...
 **/
GFileInfo*
lunarx_file_info_get_file_info (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_file_info) (file_info);
}



/**
 * lunarx_file_info_get_filesystem_info:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
GFileInfo*
lunarx_file_info_get_filesystem_info (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_filesystem_info) (file_info);
}



/**
 * lunarx_file_info_get_location:
 * @file_info : a #LunarxFileInfo.
 *
 ...
 **/
GFile*
lunarx_file_info_get_location (LunarxFileInfo *file_info)
{
  g_return_val_if_fail (LUNARX_IS_FILE_INFO (file_info), NULL);
  return (*LUNARX_FILE_INFO_GET_IFACE (file_info)->get_location) (file_info);
}



/**
 * lunarx_file_info_changed:
 * @file_info : a #LunarxFileInfo.
 *
 * Emits the ::changed signal on @file_info. This method should not
 * be invoked by Lunar plugins, instead the file manager itself
 * will use this method to emit ::changed whenever it notices a
 * change on @file_info.
 **/
void
lunarx_file_info_changed (LunarxFileInfo *file_info)
{
  g_return_if_fail (LUNARX_IS_FILE_INFO (file_info));
...
/**
 * lunarx_file_info_renamed:
 * @file_info : a #LunarxFileInfo.
 *
 * Emits the ::renamed signal on @file_info. This method should
 * not be invoked by Lunar plugins, instead the file manager
 ...
 **/
void
lunarx_file_info_renamed (LunarxFileInfo *file_info)
{
  g_return_if_fail (LUNARX_IS_FILE_INFO (file_info));
...
GType
lunarx_file_info_list_get_type (void)
{
  static GType type = G_TYPE_INVALID;

  if (G_UNLIKELY (type == G_TYPE_INVALID))
    {
      type = g_boxed_type_register_static (I_("LunarxFileInfoList"),
                                           (GBoxedCopyFunc) lunarx_file_info_list_copy,
                                           (GBoxedFreeFunc) lunarx_file_info_list_free);
    }
...
/**
 * lunarx_file_info_list_copy:
 * @file_infos: (element-type LunarxFileInfo): a #GList of #LunarxFileInfo<!---->s.
 *
 * Does a deep copy of @file_infos and returns the
 * new list.
 *
 * Returns: (transfer full) (element-type LunarxFileInfo): a copy of @file_infos.
 **/
GList*
lunarx_file_info_list_copy (GList *file_infos)
{
...
/**
 * lunarx_file_info_list_free:
 * @file_infos: (element-type LunarxFileInfo): a #GList of #LunarxFileInfo<!---->s.
 *
 * Frees the resources allocated for the @file_infos
 * list and decreases the reference count on the
 * #LunarxFileInfo<!---->s contained within.
 **/
void
lunarx_file_info_list_free (GList *file_infos)
{
