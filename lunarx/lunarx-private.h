...
#ifndef __LUNARX_PRIVATE_H__
#define __LUNARX_PRIVATE_H__
...
G_GNUC_INTERNAL
void   lunarx_object_list_take_reference (GList      *object_list,
                                           gpointer    target);

G_GNUC_INTERNAL
gchar *lunarx_param_spec_get_option_name (GParamSpec *pspec) G_GNUC_MALLOC;

G_END_DECLS

#endif /* !__LUNARX_PRIVATE_H__ */
