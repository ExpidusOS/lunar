Lunar Advanced Properties (lunar-apr)
=======================================

Lunar-apr is an extension to Lunar, which provides additional pages forthe file properties dialog, that are displayed for certain kinds of files:
