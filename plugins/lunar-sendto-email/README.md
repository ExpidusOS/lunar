Lunar Sendto Email (lunar-sendto-email)
=========================================

Lunar-sendto-email is an extension to Lunar, which adds an additional entry to the "Send To" sub menu, named "Mail Recipient", that starts the mail composer and attaches the selected files (using the endo-open mechanism).
